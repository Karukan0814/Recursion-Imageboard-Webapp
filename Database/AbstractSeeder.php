...
abstract class AbstractSeeder implements Seeder {
    ...
    protected function validateRow(array $row): void {
        ...
        foreach ($row as $i=>$value) {
            ...
            if ((get_debug_type($value)!=="null") &&get_debug_type($value) !== $columnDataType) throw new \InvalidArgumentException(sprintf("Value for %s should be of type %s. Here is the current value: %s", $columnName, $columnDataType, json_encode($value)));
        }
    }
